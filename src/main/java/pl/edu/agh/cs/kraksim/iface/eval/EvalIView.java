...
public class EvalIView extends ModuleView<CityEvalIface, NULL, NULL, NULL, NULL, LaneEvalIface> {

	public EvalIView(Module module) throws InvalidClassSetDefException, UnsatisfiedContractException {
		super(module);
	}
}
