...
public final class GeometryHelper {
	 ...
	 * </ul>
	 */
	public static double[] computeVectors(Point2D start, Point2D end) {
		...
		final double[] vectorAB = {deltaX / distance, deltaY / distance};
     ...
     * 
     */
		return new double[]{vectorAB[0], vectorAB[1]};
	}
}
