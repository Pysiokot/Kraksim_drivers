...
public class Policy {
    ...
    public Object getQTable(){
        Object currTable = qValuesTable;

        //String result =Arrays.deepToString((Object[]) currTable).replaceAll("],", "]," + System.getProperty("line.separator"));
        return currTable;
    }
