...
public class RLCDModuleCreator extends ModuleCreator<CityRLCDExt, NULL, NULL, NULL, NULL, LaneRLCDExt> {
	...
	public RLCDModuleCreator(CarInfoIView carInfoView, BlockIView blockView, RLCDParams params) {
